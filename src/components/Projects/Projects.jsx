        ...
        <div className={styles.container}>
            ...
            <div className={styles.main}>
                <div className={styles.game}>
                    <a href="https://juderem.github.io/switch-case-game/" target="_blank" rel="noreferrer">
                    ...
                    <a href="https://github.com/juderem/switch-case-game" target="_blank" rel="noreferrer">
                        <FontAwesomeIcon icon={['fab', 'github']} className={styles.icon}/>
                    </a>
                    
                </div>
                <div className={styles.calc}>
                    <a href="https://juderem.github.io/jucalculate/" target="_blank" rel="noreferrer">
                    ...
                    <a href="https://github.com/juderem/jucalculate" target="_blank" rel="noreferrer">
                        <FontAwesomeIcon icon={['fab', 'github']} className={styles.icon}/>
                    </a>
                </div>
                <div className={styles.morse}>
                    <a href="https://juderem.github.io/morse-code-translator/" target="_blank" rel="noreferrer">
                    ...
                    <a href="https://github.com/juderem/morse-code-translator" target="_blank" rel="noreferrer">
                        <FontAwesomeIcon icon={['fab', 'github']} className={styles.icon}/>
                    </a>
                </div>
                <div className={styles.beer}>
                    <a href="https://juderem.github.io/beer/" target="_blank" rel="noreferrer">
                    ...
                    <a href="https://github.com/juderem/beer" target="_blank" rel="noreferrer">
                        <FontAwesomeIcon icon={['fab', 'github']} className={styles.icon}/>
                    </a>
